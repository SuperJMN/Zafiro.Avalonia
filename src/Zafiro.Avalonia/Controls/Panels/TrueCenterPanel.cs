...
public class TrueCenterPanel : Panel
{
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        // 3) Available width for the center = total - 2*side (clamped to >= 0)
        ...
        // 4) The required height = the maximum of the three
    ...
    protected override Size ArrangeOverride(Size finalSize)
    {
        ...
        // side = largest width between Left / Right
        ...
        if (centerChild != null)
        {
            // Center slice = [side .. (finalSize.Width - side)]
    ...
    private double GetTop(Control child, double containerHeight, double arrangedHeight)
    {
        return child.VerticalAlignment switch
        {
            ...
            VerticalAlignment.Stretch => 0, // and the height spans the entire available space
            _ => 0
        };
    }

    /// <summary>
    /// Calculates the final height that the child must occupy based on its VerticalAlignment.
    /// </summary>
